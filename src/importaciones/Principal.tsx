...
import imgImage from "../imagenes/aa1a95bc607dc1fc933ff383be0cf8024b068732.png";
import imgImage1 from "../imagenes/38b537f7c3d943ba8fdeec109470b734b1fa3f31.png";
import imgImage3 from "../imagenes/b6d521758aae91b27322e3f74aa38fe014ea55ea.png";
    ...
    <div className="h-[200px] md:h-[250px] lg:h-[300px] overflow-clip relative w-full" data-name="HeroInversiones">
      ...
      <div className="absolute inset-0 flex items-center justify-center px-6 md:px-12 lg:px-24">
        <div className="max-w-3xl text-center">
          <p className="font-['Arial:Regular',sans-serif] text-[28px] md:text-[38px] lg:text-[48px] text-white tracking-[0.7px] uppercase mb-4 font-bold">
            Invierte con Libella
          </p>
          <p className="font-['Arial:Regular',sans-serif] text-[14px] md:text-[16px] lg:text-[18px] text-white leading-relaxed">
    ...
    <div className="bg-gradient-to-b from-[rgba(198,41,38,0.97)] to-[#403838] py-12 md:py-16 lg:py-20 px-6 md:px-12 lg:px-24 relative w-full overflow-hidden" data-name="SeccionTiposInversion">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="mt-12 md:mt-16 flex justify-center">
          <a 
            href="https://wa.me/573155456029?text=Hola,%20estoy%20interesado%20en%20invertir%20con%20Libella"
            target="_blank"
