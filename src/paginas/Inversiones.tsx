...
import svgPaths from "../recursos/svg/pathsInversiones";
          ...
          {menuItemsLeft.map((item, index) => (
            <Link key={item} to={getPath(item)}>
              ...
              >
                ...
                <motion.div
                  className={`absolute bottom-[-4px] left-0 h-[2px] bg-white ${item === 'INVERSIONES' ? 'w-full' : 'w-0'}`}
          ...
          {menuItemsRight.map((item, index) => (
            <Link key={item} to={getPath(item)}>
              ...
              >
                <span className="relative z-10">{item}</span>
                <motion.div
                  className="absolute bottom-[-4px] left-0 h-[2px] bg-white w-0"
                  whileHover={{ width: '100%' }}
                  transition={{ duration: 0.3 }}
                />
              </motion.div>
